          ...
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <div className="rounded-2xl border border-edge bg-panel/40 p-8 sm:p-12">
              <p className="text-sand/60 mb-8">
                <strong className="text-cream">Última actualización:</strong> Julio 2026
              </p>
              ...
              <section className="mb-12">
                ...
                <div className="space-y-4 text-sand/70">
                  <p className="leading-relaxed">
                    <strong className="text-cream">2.1 Datos de contacto:</strong> Nombre, número
                    de teléfono, correo electrónico y dirección de envío, proporcionados al
                    consultar o realizar un pedido.
                  </p>
                  <p className="leading-relaxed">
                    <strong className="text-cream">2.2 Datos de la operación:</strong> Historial de
                    pedidos, preferencias de producto y comunicaciones sostenidas por WhatsApp o
                    correo electrónico.
                  </p>
                  <p className="leading-relaxed">
                    <strong className="text-cream">2.3 Datos de navegación:</strong> Información
              ...
              <section className="mb-12">
                ...
                <div className="space-y-4 text-sand/70">
                  <p className="leading-relaxed">
                    <strong className="text-cream">4.1 Empresas de envío:</strong> Compartimos los
                    datos de contacto y dirección estrictamente necesarios con MRW y Zoom para
                    completar la entrega de tu pedido.
                  </p>
                  <p className="leading-relaxed">
                    <strong className="text-cream">4.2 Proveedores y alianzas B2B:</strong> Los
                  ...
                  <p className="leading-relaxed">
                    <strong className="text-cream">4.3 No vendemos datos:</strong> No comercializamos
              ...
              <section className="mb-12">
                ...
                <p className="text-sand/70 leading-relaxed">
                  ...
                  escribiendo a{' '}
                  <span className="text-cream font-medium">soporte@avilamusic.store</span>.
              ...
              <section>
                ...
                <div className="rounded-xl border border-edge bg-raised/50 p-6">
                  <p className="text-sand/60">
                    ...
                    <strong className="text-cream">Soporte:</strong> soporte@avilamusic.store<br />
                    <strong className="text-cream">Horario:</strong> Lunes a Viernes 10am-6pm, Sábados 10am-1pm
                  </p>
                </div>
              </section>
            </div>
      ...
      <section className="py-20 bg-gradient-to-b from-ink to-panel/30">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          <div className="rounded-2xl border border-edge bg-panel/40 p-8">
            <Lock className="h-12 w-12 text-gold mx-auto mb-4" strokeWidth={1.5} />
            <p className="text-sand/60">
